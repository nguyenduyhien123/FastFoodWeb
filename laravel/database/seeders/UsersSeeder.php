    ...
    public function run(): void
    {
        DB::table('users')->insert([
            [
                ...
                'avatar' => 'https://scr.vn/wp-content/uploads/2020/07/%E1%BA%A2nh-n%E1%BB%81n-bi%E1%BB%83n-%C4%91%E1%BA%B9p-trong-xanh.jpg', 'created_at' => Carbon::now(),
            ...
            [
                ...
                'avatar' => 'https://phunugioi.com/wp-content/uploads/2020/02/hinh-anh-dep-thien-nhien.jpg', 'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                'id' => 3,
                'username' => 'nguyenduyhien2',
                'email' => '0306211034@caothang.edu.vn',
                'email_verified_at' => '2023-11-29',
                'password' => Hash::make('password'),
                'firstname' => 'Hiện Hiện',
                'lastname' => 'Nguyễn Duy',
            ...
            [
                ...
                'avatar' => 'https://www.fodors.com/wp-content/uploads/2021/09/3-FallFoliage-Aspen-shutterstock_1866243163-390x260.jpg', 'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                'id' => 5,
                ...
                'avatar' => 'https://fatafatsewa.com/storage/media/76/ktslI21609.jpg', 'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                'id' => 6,
                ...
                'avatar' => 'https://msmobile.com.vn/upload_images/images/hinh-nen-thien-nhien-dep-cho-laptop-7.jpg', 'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                'id' => 7,
