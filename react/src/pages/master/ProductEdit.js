            ...
            <Row>
                ...
                <Col xl={12}>
                    <CardLayout>
                        ...
                        <Row>
                            <Col xl={12}><LabelField type="text" label="Tên sản phẩm" fieldSize="w-100 h-md" name="name" onChange={handleChange}/></Col>
                            <Col xl={12}><LabelField type="text" label="Mô tả sản phẩm" fieldSize="w-100 h-md" name="description" onChange={handleChange}/></Col>
                            <Col xl={6}><LabelField label="Loại sản phẩm" option={productTypes} fieldSize="w-100 h-md" name="product_type_id" onChange={handleChange}/></Col>
                            <Col xl={6}><LabelField type="number" label="Giá" fieldSize="w-100 h-md" name="price" onChange={handleChange}/></Col>
                        </Row>
                    </CardLayout>
                </Col>
                <Col xl={12}>
