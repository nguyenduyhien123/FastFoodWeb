            ...
            <tr key={wishlist.id}>
              ...
              <td>
                {wishlist.product_image ? (
                  <img src={wishlist.product_image[0]?.startsWith('https') ? wishlist.product_image[0] : `http://localhost:8000/storage/uploads/${wishlist.product_image[0]}`} alt="" className='img-thumbnail ' />
                ) : (
              ...
              <td>
                <button type="button" className="btn btn-primary" onClick={() => handleDetail(wishlist.id)}>Xem chi tiết</button>
              </td>
            </tr>
          ))}
        </tbody>
