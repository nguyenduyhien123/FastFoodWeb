    ...
    return (
      <section className='product_card h-100 card' data-aos="flip-left" data-aos-duration="1000">
          ...
          <div className="rating d-flex justify-content-center">
            <Rating size={20} rating={star} hoverColor='red' onRatingChanged={e => console.log(e)}></Rating>
          </div>
              <div className='d-flex justify-content-between gap-2 align-items-center mb-4'>
              <h6 className='product-name'>{name}</h6>
              <Button className={"material-icons favorite"} onClick={() => handleAddToFavorite(id)}>favorite</Button></div>
