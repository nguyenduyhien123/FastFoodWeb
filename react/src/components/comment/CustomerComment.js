...
export default function CustomerComment({ data }) {
    return (
        <>
                        ...
                        <Box className="mc-review-data">
                            <Box className="mc-review-head">
                                <Box className="mc-review-user">
                                    <RoundAvatar src={ item?.user?.avatar?.startsWith('https') ? item?.user?.avatar : `http://localhost:8000/storage/uploads/${item?.user?.avatar }`} alt={ item.alt } size="sm" />
                                    <DuelText title={ item?.user?.fullname } descrip={ item?.created_at } size = "sm" />
                            ...
                            <Text className="mc-review-describe">{ item?.content }</Text>
                        </Box>
